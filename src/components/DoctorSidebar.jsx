  ...
  useEffect(() => {
    ...
    const fetchDoctorData = async () => {
      try {
        ...
        if (docSnap.exists()) {
          console.log("Fetched doctor data:", docSnap.data());
    ...
    <>
      ...
      <div className={`fixed md:relative z-40 w-64 min-h-screen bg-blue-900 text-white flex flex-col transition-all duration-300 ${isOpen ? 'left-0 ' : '-left-64'} md:left-0`}>
        ...
        <div className="p-5 border-b border-blue-800 flex flex-col items-center space-y-3 pt-20 lg:pt-6">
          ...
          <div>
            <h2 className="text-xl font-bold truncate">{user?.displayName || 'Doctor'}</h2>
            ...
            <li>
              <NavLink 
                ...
                className={({isActive}) => 
                 ...
                 onClick={() => setIsOpen(false)}
              >
                <FaUserInjured className="mr-3 flex-shrink-0" />
             ...
             <li>
              <NavLink 
                ...
                className={({isActive}) => 
                 ...
                 onClick={() => setIsOpen(false)}
               >
               <FaNotesMedical className="mr-3 flex-shrink-0" />
