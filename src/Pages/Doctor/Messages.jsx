...
const Messages = () => {
  ...
  useEffect(() => {
    ...
    const q = query(
      messagesRef,
      where("senderId", "in", [user.uid, selectedPatientId]),
      where("receiverId", "in", [user.uid, selectedPatientId]),
  ...
  return (
    ...
    <div className="min-h-screen flex bg-gradient-to-r from-blue-50 to-purple-50 p-5 ">
    <DoctorSidebar/>
      <div className="w-full lg:w-3/4 p-5 bg-white rounded-lg shadow-lg overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 mt-8 lg:mt-0 p-6">
